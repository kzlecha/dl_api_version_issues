...
for library in libraries.keys():
    print(library)
    print("count:", libraries[library])
    print("percentage:", round(libraries[library]/len(df_libraries) * 100, 2), "%")


libraries = {"pytorch":0, "tensorflow":0, "keras":0, "tessaract": 0, "tesseract":0, "pyspark":0, "caffe":0, "theano":0}
...
for library in libraries.keys():
    print(library)
    print("count:", libraries[library])
    print("percentage:", round(libraries[library]/len(df_keywords) * 100, 2), "%")
